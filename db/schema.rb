...
ActiveRecord::Schema.define(version: 20180524055329) do
  ...
  add_index "comentarios", ["incidencia_id"], name: "index_comentarios_on_incidencia_id"
  ...
  add_index "incidencias", ["departamento_id"], name: "index_incidencias_on_departamento_id"
  add_index "incidencias", ["user_id"], name: "index_incidencias_on_user_id"
  ...
  create_table "user_mesas", force: true do |t|
    t.integer  "user_id"
    t.integer  "departamento_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  add_index "user_mesas", ["departamento_id"], name: "index_user_mesas_on_departamento_id"
  add_index "user_mesas", ["user_id"], name: "index_user_mesas_on_user_id"
